...
return [
    ...
    | que son proporcionados por el intermediario de contraseñas para un intento de actualización de
    | contraseña que ha fallado, como por un token inválido o una nueva contraseña inválida.
    |
    */
